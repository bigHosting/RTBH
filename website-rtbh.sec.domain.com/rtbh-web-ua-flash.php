...
if ( isset($_GET['time']) && is_numeric($_GET['time']) && ($_GET['time'] > 300) && ($_GET['time'] < 7200) )
{
...
if ( isset($_GET['hits']) && is_numeric($_GET['hits']) && ($_GET['hits'] > 99) && ($_GET['hits'] < 5000) )
{
    $MIN_HITS = $_GET['hits'];
...
function getGraylogMessages($range,$method,$filename){
        ...
        $query = 'user_agent:"Shockwave Flash"';
