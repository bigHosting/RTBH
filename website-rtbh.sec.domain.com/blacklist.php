...
$db = new dbHelper();
$rows = $db->select6("blacklist",array());
...
if ( count ( $rows['data'] ) > 0)
{
         ...
         foreach($rows['data'] as $array){
                        ...
                        echo       "<td align=left nowrap>
                                        ...
                                        <a href=\"add.php?table=temp_whitelist&ip=$sourceip\"  class=\"hint--left  hint--info hint--rounded\" data-hint=\"Delete + Whitelist for 48 Hours\"><img src=\"common/whitelist.png\" height=\"16px\" weigh=\"16px\"></a>
                                        <a href=\"add.php?table=blacklist\"            class=\"hint--left  hint--success hint--rounded\" data-hint=\"Add new entry\"><img src=\"common/112.png\" height=\"16px\" weigh=\"16px\"></a>";
        ...
        <div>
            ...
            <script>
                $(document).ready(function() {
                    $('#example').dataTable( {
                            "lengthMenu": [[1000, 5000, 10000, -1], [1000, 5000, 10000, "All"]]
                    } );
                });
            </script>
        </div>
