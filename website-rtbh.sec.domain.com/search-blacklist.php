...
<form name="search_form" method="GET" action="search-blacklist-submit.php">
    <center>

    <div><input type="text" name="ip" id="keyword" class="typeahead tt-query" autocomplete="on" spellcheck="false" placeholder="Type your IP">
