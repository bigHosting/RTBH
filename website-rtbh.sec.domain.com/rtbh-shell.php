...
if ( isset($_GET['hits']) && is_numeric($_GET['hits']) && ($_GET['hits'] > 300) )
{
        $MIN_HITS = $_GET['hits'];
...
if ( isset($_GET['time']) && is_numeric($_GET['time']) && ($_GET['time'] > 299) )
{
...
function getGraylogMessages($range,$SEARCH){
        ...
        $graylog_api_pass = "ANOTHER_GRAYLOG_API_PASSWORD_HERE";
